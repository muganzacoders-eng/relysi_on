...
function AboutPage() {
  ...
  const team = [
    { name: 'Dr. Sarah Johnson', role: 'CEO & Founder', avatar: '/images/team1.jpg' },
    { name: 'Prof. Michael Chen', role: 'Head of Education', avatar: '/images/team2.jpg' },
    { name: 'Lisa Rodriguez', role: 'CTO', avatar: '/images/team3.jpg' }
  ];
